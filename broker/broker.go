...
func (b *Broker) Update(ctx context.Context, instanceID string, details brokerapi.UpdateDetails, asyncAllowed bool) (brokerapi.UpdateServiceSpec, error) {
	...
	if userParameters.MaxMemoryPolicy == nil && userParameters.PreferredMaintenanceWindow == "" && userParameters.TestFailover == nil && userParameters.AutoFailover == nil {
	...
	if userParameters.TestFailover != nil {
		err := b.provider.TestFailover(providerCtx, instanceID)
		if err != nil {
